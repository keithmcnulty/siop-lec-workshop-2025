...
go into the Posit Cloud workspace, open the module on R fundamentals, and try to complete the exercises in that module.  Solutions are provided the links in the agenda.  The less time we need to spend on fundamentals in this workshop, the more time we can spend on learning how to model. 
